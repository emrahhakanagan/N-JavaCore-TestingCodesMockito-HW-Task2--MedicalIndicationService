...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //run service
        BloodPressure currentPressure = new BloodPressure(120, 80); // BloodPressure(60, 120) org from task
        medicalService.checkBloodPressure(id1, currentPressure);

        BigDecimal currentTemperature = new BigDecimal("37.9"); // BigDecimal("37.9") org from task
